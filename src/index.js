...
const deleteFormIncompleteList = (taget) => {
...
const cretateIncompleteList = (text) => {
  ...
  completeButton.addEventListener("click", () => {
    ...
    // const completeTeret = completeButton.parentNode;
    // document.getElementById("incomplete-list").removeChild(completeTeret);
  ...
  deleteButton.addEventListener("click", () => {
    ...
    // const deleteTeret = deleteButton.parentNode;
    // document.getElementById("incomplete-list").removeChild(deleteTeret);
